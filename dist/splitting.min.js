...
return n&&(u.className=n),i&&(!o&&u.setAttribute("data-"+n,i),u.textContent=i),e&&r(e,u)||u}function o(t,e){return t.getAttribute("data-"+e)}function u(t,e){return t&&0!=t.length?t.nodeName?[t]:[].slice.call(t[0].nodeName?t:document.querySelectorAll(t)):[]}function l(t){let e=[]
for(;t--;)e[t]=[]
...
return u(t.target||"[data-splitting]").map((function(r){let i=r["🍌"]
...
c(r,(function(t,e){Array.isArray(t)?c(t,(function(t){n(t,o,e)})):n(t,o,e)})),n(t,i+"-total",r.length)}(r,u,l),i[o]=l,r.classList.add(o)}})),r.classList.add("splitting"),i}))}function T(t,e,n){let r=u(e.matching||t.children),i={}
