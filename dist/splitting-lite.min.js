...
return n&&(o.className=n),r&&(!u&&o.setAttribute("data-"+n,r),o.textContent=r),e&&i(e,o)||o}function u(t,e){return t&&0!=t.length?t.nodeName?[t]:[].slice.call(t[0].nodeName?t:(e||document).querySelectorAll(t)):[]}function o(t,e){t&&t.some(e)}function l(t){return function(e){return t[e]}}let c={}
...
return u(t.target||"[data-splitting]").map((function(i){let r=i["🍌"]
...
let w=f("lines",[h],"line",(function(t,e,n){return function(t,e,n){let i=u(e.matching||t.children,t),r={}
