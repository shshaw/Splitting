...
return n&&(i.className=n),e&&(!r&&i.setAttribute("data-"+n,e),i.textContent=e),t&&f(t,i)||i}function n(t,n){return t&&0!=t.length?t.nodeName?[t]:[].slice.call(t[0].nodeName?t:(n||u).querySelectorAll(t)):[]}function h(t,n){t&&t.some(n)}var o={}
...
var e=p(s,r,t)
a.push(e),c.push(e)})," "===n[n.length-1]&&c.push(d(" ")))}else c.push(t)}),h(c,function(t){f(s,t)}),t.innerHTML="",f(t,s),a}var i="words",a=t(i,0,"word",function(t){return v(t,"word",/\s+/,0,1)}),m="chars",s=t(m,[i],"char",function(t,e,n){var r=[]
return h(n[i],function(t,n){r.push.apply(r,v(t,"char","",e.whitespace&&n))}),r})
function c(e){var f=(e=e||{}).key
...
return t}({},e)
return h(n,function(t){if(t.split){var n=t.by,e=(f?"-"+f:"")+t.key,r=t.split(s,d,c)
