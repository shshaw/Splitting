...
n.length?p(n.split(r),function(t,n){n&&o&&s(a,""," "),u.push(s(a,e,t))}):c(a,t)}),t.innerHTML="",c(t,a),u}var i="words",o=t(i,0,"word",function(t){return d(t,"word",/\s+/,0,1)}),a="chars",l=t(a,[i],"char",function(t,e,n){var r=[]
...
return p(r(d.by||c.dataset.splitting||a),function(t){if(t.split){var n=t.by,e=(l?"-"+l:"")+t.key,r=t.split(c,d,s)
